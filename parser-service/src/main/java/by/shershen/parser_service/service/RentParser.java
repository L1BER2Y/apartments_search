...
import by.shershen.parser_service.service.api.IRentParser;
...
import static by.shershen.parser_service.service.utils.PaginationParser.parseNextPageLink;

@Slf4j
@Component
public class RentParser implements IRentParser {
    ...
    private FlatEntity convertToFlat(Element section) {
        ...
        flat.setOfferType(OfferType.RENT);
